#!/usr/bin/python3
"""
This module conducts testing for the BaseModel module
"""
...
class TestBaseModel(unittest.TestCase):
    """
    Describing the TestBaseModel class
    """
    def test_init_with_kwargs(self):
        """
        Conducting tests on the __init__ call with **kwargs
        """
        data = {
                'id': '1234',
    ...
    def test_init_without_kwargs(self):
        """
        Testing the __init__ call without **kwargs in the specified context
        """
        obj = BaseModel()
    ...
    def test_str_representation(self):
        """
        Evaluating the __str__ representation of the BaseModel class through testing
        """
    ...
    def test_to_dict(self):
        """
        Conducting tests on the to_dict() method within the BaseModel class
        """
