#!/usr/bin/python3
"""
Conducting testing on the console.py module.
"""
...
class TestHBNBCommand(unittest.TestCase):
    """
    Evaluating the HBNBCommand module through testing.
    """
    def setUp(self):
    ...
    def test_help_message(self):
        """
        Verifying commands displayed during help call testing.
        """
    ...
    def test_invalid_command(self):
        """
        Verifying invalid miscellaneous commands.
        """
        with patch('sys.stdout', new=StringIO()) as output:
